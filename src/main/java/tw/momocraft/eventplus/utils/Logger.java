...
public class Logger {
    ...
    public Logger() {
        file = new File(tw.momocraft.eventplus.EventPlus.getInstance().getDataFolder().getPath() + "\\Logs" + "\\latest.log");
    }

    public void createLog() {
        File logFolder = new File(tw.momocraft.eventplus.EventPlus.getInstance().getDataFolder().getPath() + "\\Logs");
        if (!logFolder.exists()) {
            try {
                if (!logFolder.mkdir()) {
