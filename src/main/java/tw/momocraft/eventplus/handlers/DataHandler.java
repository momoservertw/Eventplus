...
public class DataHandler {
    ...
    static boolean saveLogs(File backupFile, Table<String, String, List<String>> cleanTable) {
        ...
        ConfigHandler.getLogger().sendLog("---- EventPlus Clean Log ----", false);
    ...
    static String getBackupPath() {
        ...
        switch (backupMode) {
            case "plugin":
                backupPath = tw.momocraft.eventplus.EventPlus.getInstance().getDataFolder().getPath() + "\\" + backupFolderName + "\\" + backupTimeName;
                break;
            case "custom":
                ...
                if (backupCustomPath != null) {
                    ...
                    backupPath = tw.momocraft.eventplus.EventPlus.getInstance().getDataFolder().getPath() + "\\Backup\\" + backupTimeName;
                }
                break;
            default:
