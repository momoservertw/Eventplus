...
public class UpdateHandler {
	...
	private String versionExact = tw.momocraft.eventplus.EventPlus.getInstance().getDescription().getVersion();
	...
	UpdateHandler(){
		this.checkUpdates(tw.momocraft.eventplus.EventPlus.getInstance().getServer().getConsoleSender());
	}
	...
	public void checkUpdates(CommandSender sender) {
		if (this.updateNeeded(sender) && this.updatesAllowed) {
			...
			ServerHandler.sendMessage(sender, "&ehttps://www.spigotmc.org/resources/eventplus.75169/history");
