    ...
    private List<String> getExpiredUUIDDataList(String title, List<String> dataList) {
        ...
        for (String data : dataList) {
            ...
            if (offlinePlayer.getName() != null) {
                if (!PermissionsHandler.hasPermissionOffline(offlinePlayer, "eventplus.bypass.clean." + title.toLowerCase()) && !PermissionsHandler.hasPermissionOffline(offlinePlayer, "eventplus.bypass.clean.*")) {
                    if (ConfigHandler.getDepends().AuthmeEnabled()) {
